  ...
  begin
    ...
    case(int_case_reg)
      ...
      begin
        ...
        if(int_addrA_reg == 4*nsamples-1) // clear until all the addresses are zero
        begin
          int_case_next = 3'd2;
		  int_wren_next = 1'b0;
		  int_addrA_next = -1;
      ...
      begin
        int_wren_next = 1'b0;
        n_count_next = 0;
        if(int_addrA_reg == 4*nsamples-1)
        begin
          int_addrA_next = -1;
          int_addrB_next = 0;
          int_averages_next = int_averages_reg + 1;
        end
        case(int_averages_reg)
          naverages: int_case_next = 3'd4;
          default:
            begin
            if(trigger)
                int_case_next = 3'd3;
